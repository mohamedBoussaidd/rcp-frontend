...
export class NavSidebarComponent {
  ...
  private readonly allItems: NavItem[] = [
    ...
    { label: 'Calendrier',   icon: 'calendar_month', route: '/calendrier',  roles: ['SUPER_ADMIN', 'PRESIDENT', 'ENTRAINEUR', 'PREPARATEUR', 'MEDICAL', 'JOUEUR'] },
    { label: 'Séances',      icon: 'fitness_center', route: '/seances',     roles: ['SUPER_ADMIN', 'PRESIDENT', 'ENTRAINEUR', 'PREPARATEUR', 'MEDICAL'] },
